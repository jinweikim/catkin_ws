...
"""autogenerated by genpy from moveit_interface/RobotControlRequest.msg. Do not edit."""
import sys
...
class RobotControlRequest(genpy.Message):
  _md5sum = "4fbb0c19b79d8c57131c5452b4dd3897"
  _type = "moveit_interface/RobotControlRequest"
...
float64[] extra
"""
  __slots__ = ['type','x','y','z','roll','pitch','yaw','extra']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       type,x,y,z,roll,pitch,yaw,extra
...
def _get_struct_6d():
    ...
    return _struct_6d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from moveit_interface/RobotControlResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class RobotControlResponse(genpy.Message):
  ...
  _type = "moveit_interface/RobotControlResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class RobotControl(object):
  _type          = 'moveit_interface/RobotControl'
  _md5sum = 'f4178e569aa36a63f67d15ee7547eaac'
