...
(cl:in-package moveit_interface-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <RobotControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_interface-srv:<RobotControl-request> is deprecated: use moveit_interface-srv:RobotControl-request instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <RobotControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_interface-srv:type-val is deprecated.  Use moveit_interface-srv:type instead.")
  (type m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <RobotControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_interface-srv:x-val is deprecated.  Use moveit_interface-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <RobotControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_interface-srv:y-val is deprecated.  Use moveit_interface-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <RobotControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_interface-srv:z-val is deprecated.  Use moveit_interface-srv:z instead.")
  (z m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <RobotControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_interface-srv:roll-val is deprecated.  Use moveit_interface-srv:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <RobotControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_interface-srv:pitch-val is deprecated.  Use moveit_interface-srv:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <RobotControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_interface-srv:yaw-val is deprecated.  Use moveit_interface-srv:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'extra-val :lambda-list '(m))
(cl:defmethod extra-val ((m <RobotControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_interface-srv:extra-val is deprecated.  Use moveit_interface-srv:extra instead.")
  (extra m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobotControl-request>)))
  ...
  "moveit_interface/RobotControlRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobotControl-request)))
  "Returns string type for a service object of type 'RobotControl-request"
  "moveit_interface/RobotControlRequest")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RobotControl-request>)))
  ...
  "f4178e569aa36a63f67d15ee7547eaac")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RobotControl-request)))
  "Returns md5sum for a message object of type 'RobotControl-request"
  "f4178e569aa36a63f67d15ee7547eaac")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotControl-request>)))
  ...
  (cl:format cl:nil "string type~%float64 x~%float64 y~%float64 z~%float64 roll~%float64 pitch~%float64 yaw~%float64[] extra~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotControl-request)))
  "Returns full string definition for message of type 'RobotControl-request"
  (cl:format cl:nil "string type~%float64 x~%float64 y~%float64 z~%float64 roll~%float64 pitch~%float64 yaw~%float64[] extra~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <RobotControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name moveit_interface-srv:<RobotControl-response> is deprecated: use moveit_interface-srv:RobotControl-response instead.")))

(cl:ensure-generic-function 'execute_result-val :lambda-list '(m))
(cl:defmethod execute_result-val ((m <RobotControl-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader moveit_interface-srv:execute_result-val is deprecated.  Use moveit_interface-srv:execute_result instead.")
  (execute_result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RobotControl-response>)))
  ...
  "moveit_interface/RobotControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RobotControl-response)))
  "Returns string type for a service object of type 'RobotControl-response"
  "moveit_interface/RobotControlResponse")
