...
class RobotControlRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('virtual_debug')) {
        this.virtual_debug = initObj.virtual_debug
      }
      else {
        this.virtual_debug = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [virtual_debug]
    bufferOffset = _serializer.bool(obj.virtual_debug, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [virtual_debug]
    data.virtual_debug = _deserializer.bool(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.virtual_debug !== undefined) {
      resolved.virtual_debug = msg.virtual_debug;
    }
    else {
      resolved.virtual_debug = false
    }
...
class RobotControlResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'interface/RobotControlResponse';
  }
...
module.exports = {
  ...
  md5sum() { return '06190d94b32e42f9d6491ffb2f6939f0'; },
  datatype() { return 'interface/RobotControl'; }
};
